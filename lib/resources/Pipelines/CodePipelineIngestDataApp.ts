...
export class CICDIngestDataStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const sourceAction = new GitHubSourceAction({
      ...
      repo: process.env.REPOSITORY_INGEST_CRIPTO_DATA || ' ',
    ...
    const application = new ServerApplication(this, 'IngestDataApplication', {
      applicationName: 'IngestData',
    });

    const deploymentGroup = new ServerDeploymentGroup(this, 'MyDeploymentGroup', {
      application: application,
      deploymentGroupName: 'MyFastApiDeploymentGroup',
    ...
    const pipeline = new Pipeline(this, 'MyPipeline', {
      pipelineName: 'MyFastApiPipeline',
      stages: [
        {
          stageName: 'Source',
